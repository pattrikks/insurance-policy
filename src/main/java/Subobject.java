...
public class Subobject {
    ...
    Object assigned_object = null; // the object that the subobject is assigned to
    ...
    /**
     * method to check if the Subobject is fully defined
     * (has a name, insured price and risk type)
     */
    ...
    public static void addSubobjectToObject(Object obj, Subobject subobj) {
        /**
         * checks if subobject is fully defined and
         * is not already related to an object
         */
        if (subobj.assigned_object == null && subobj.SubobjectIsComplete(subobj)) {
